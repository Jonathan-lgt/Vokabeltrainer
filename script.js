const units = {
    ...
    3: {
        name: "Unité 3",
        words: {
            131: {de: ["eine Grenze"], fr: ["une frontiére"]},
            132: {de: ["belgisch"], fr: ["belge"]},
            133: {de: ["eine Hauptstadt"], fr: ["une capitale"]},
            134: {de: ["flämisch"], fr: ["flamand", "flamande"]},
            135: {de: ["ein Rathaus"], fr: ["un hôtel de ville"]},
            136: {de: ["ein Glockenturm"], fr: ["un beffroi"]},
            137: {de: ["ein Trödelmarkt"], fr: ["une braderie"]},
            138: {de: ["mehr als"], fr: ["plus de"]},
            139: {de: ["ein Besucher", "eine Besucherin"], fr: ["un visiteur", "une visiteuse"]},
            140: {de: ["ein Akzent"], fr: ["un accent"]},
            141: {de: ["ein Einwohner", "eine Einwohnerin"], fr: ["un habitant", "une habitante"]},
            142: {de: ["eine Spezialität"], fr: ["une spécialité"]},
            143: {de: ["ein Charakter"], fr: ["une caractère"]},
            144: {de: ["multikulturell"], fr: ["multiculturel", "multiculturelle"]},
            145: {de: ["eine Kreuzung", "ein Schnittpunkt"], fr: ["un carrefour"]},
            146: {de: ["Europa"], fr: ["l'Europe"]},
            147: {de: ["Brüssel"], fr: ["Bruxelles"]},
            148: {de: ["London"], fr: ["Londres"]},
            149: {de: ["europäisch"], fr: ["européen", "européenne"]},
            150: {de: ["eine Kultur"], fr: ["une culture"]},
            151: {de: ["eine Gemeinsamkeit"], fr: ["un point commun"]},
            152: {de: ["das Mittelmeer"], fr: ["la Méditerranée"]},
            153: {de: ["alt"], fr: ["ancien", "ancienne"]},
            154: {de: ["lebendig", "lebhaft"], fr: ["vivant", "vivante"]},
            155: {de: ["eine Seife"], fr: ["un savon"]},
            156: {de: ["eine Felsbucht"], fr: ["une calanque"]},
            157: {de: ["Frankfurt"], fr: ["Francfort"]},
            158: {de: ["ein Flohmarkt"], fr: ["un marché aux puces"]},
            159: {de: ["gerade etw. tun"], fr: ["être en train de faire qc"]},
            159: {de: ["ein Schnäppchen"], fr: ["une bonne affaire"]},
            160: {de: ["ein Wahnsinn"], fr: ["une folie"]},
            161: {de: ["ein Engländer", "eine Engländerin"], fr: ["un Anglais", "une Anglaise"]},
            162: {de: ["gerade etw. getan haben"], fr: ["venir de faire qc"]},
            163: {de: ["falsch"], fr: ["mauvais", "mauvaise"]},
            164: {de: ["da"], fr: ["comme"]},
            165: {de: ["leer"], fr: ["vide"]},
            166: {de: ["überwachen"], fr: ["surveiller"]},
            167: {de: ["ein Job"], fr: ["un job"]},
            168: {de: ["ein Student", "eine Studentin"], fr: ["un étudiant", "une étudiante"]},
            169: {de: ["gestresst"], fr: ["stressé", "stressée"]},
            170: {de: ["eine Speicherkarte"], fr: ["une carte mémoire"]},
            171: {de: ["ein Fotoapparat"], fr: ["un appareil photo"]},
            172: {de: ["bevor man etw. tut"], fr: ["avant de faire qc"]},
            173: {de: ["feiern"], fr: ["faire la fête"]},
            174: {de: ["Marokko"], fr: ["le Maroc"]},
            175: {de: ["marokkanisch"], fr: ["marocain", "marocaine"]},
            176: {de: ["ein Couscous"], fr: ["un couscous"]},
            177: {de: ["die Integration"], fr: ["l'intégration"]},
            178: {de: ["besuchen"], fr: ["rendre visite"]},
            179: {de: ["existieren"], fr: ["exister"]},
            180: {de: ["empfangen"], fr: ["accueillir"]},
            181: {de: ["ein Fremder", "eine Fremde"], fr: ["un étranger", "une étrangère"]},
            182: {de: ["eine Herkunft"], fr: ["une origine"]},
            183: {de: ["weniger als"], fr: ["moins de"]},
            184: {de: ["aus etw. hervorgehen"], fr: ["être issu de qc", "être issue de qc"]},
            185: {de: ["die Einwanderung"], fr: ["l'immigration"]},
            186: {de: ["exotisch"], fr: ["exotique"]},
            187: {de: ["Meeresfrüchte"], fr: ["des fruits de mer"]},
            188: {de: ["eine Stimmung", "eine Atmosphäre"], fr: ["une ambiance"]},
            189: {de: ["ein Spielplatz"], fr: ["une aire de jeux"]},
            190: {de: ["eine Terasse"], fr: ["une terasse"]},
            191: {de: ["ein Dach"], fr: ["un toit"]},
            192: {de: ["eine Serie"], fr: ["une série"]},
            193: {de: ["eine Sprache"], fr: ["une langue"]},
            194: {de: ["ein Künstler, eine Künstlerin"], fr: ["un artiste", "une artiste"]},
    ...
    4: {
        name: "Unité 4",
        words: {
            195: {de: ["ein Aufenthalt"], fr: ["un séjour"]},
            196: {de: ["ein Nachbar", "eine Nachbarin"], fr: ["un voisin", "une voisine"]},
            197: {de: ["ein Schüleraustausch"], fr: ["un échange scolaire"]},
            198: {de: ["ein Brieffreund", "eine Brieffreundin"], fr: ["un correspondant", "une correspondante"]},
            199: {de: ["sich informieren"], fr: ["s'informer"]},
            200: {de: ["ein Programm"], fr: ["un programme"]},
            201: {de: ["ein Reisebus"], fr: ["un car"]},
            202: {de: ["sich befinden"], fr: ["se trouver"]},
            203: {de: ["Was...?"], fr: ["Qu'est-ce qui...?"]},
            204: {de: ["ein Quiz"], fr: ["un quiz"]},
            205: {de: ["Wen...?"], fr: ["Qui est-ce que...?"]},
            206: {de: ["ein Camembert"], fr: ["un camembert"]},
            207: {de: ["normannisch"], fr: ["normand", "normande"]},
            208: {de: ["eine Küste"], fr: ["une côte"]},
            209: {de: ["eine Tapete", "ein Wandteppich"], fr: ["une tapisserie"]},
            210: {de: ["eine Eroberung"], fr: ["une conquête"]},
            211: {de: ["England"], fr: ["l'Angleterre"]},
            212: {de: ["eine Landung"], fr: ["un débarquement"]},
            213: {de: ["ein kleiner Berg"], fr: ["un mont"]},
            214: {de: ["sich verirren", "sich Verlaufen"], fr: ["se perdre"]},
            215: {de: ["zurechtkommen", "sich zu helfen wissen"], fr: ["se débrouiller"]},
            216: {de: ["ein Kontakt"], fr: ["un contact"]},
            217: {de: ["höflich"], fr: ["poli", "polie"]},
            218: {de: ["ein Koffer"], fr: ["une valise"]},
            219: {de: ["eine Sorge"], fr: ["un souci"]},
            220: {de: ["Keine Sorge!", "Kein Problem!"], fr: ["Pas de souci!"]},
            221: {de: ["dick", "groß", "schwer"], fr: ["gros", "grosse"]},
            222: {de: ["Klamotten"], fr: ["des fringues"]},
            223: {de: ["bekloppt", "irre", "verrückt", "wahnsinnig"], fr: ["dingue"]},
            224: {de: ["jdn. verrückt machen", "jdn. wahnsinnig machen"], fr: ["rendre qn dingue"]},
            225: {de: ["der Bauch"], fr: ["le ventre"]},
            226: {de: ["wagen etw. zu tun", "sich trauen, etw. zu tun"], fr: ["oser faire qc"]},
            227: {de: ["Kohldampf haben"], fr: ["avoir la dalle"]},
            228: {de: ["ein Fisch"], fr: ["un poisson"]},
            229: {de: ["köstlich", "lecker"], fr: ["délicieux", "délicieuse"]},
            230: {de: ["ein fester Freund", "eine feste Freundin"], fr: ["un petit copain", "une petite copine"]},
            231: {de: ["verlegen"], fr: ["gêné", "gênée"]},
            232: {de: ["etw. ist mit jdm. los", "etw. passiert jdm."], fr: ["qc arrive "]},
            233: {de: ["vermeiden"], fr: ["éviter"]},
            234: {de: ["dämlich"], fr: ["débile"]},
            235: {de: ["gemein", "böse"], fr: ["méchant", "méchante"]},
            236: {de: ["eine Abtei"], fr: ["une abbaye"]},
            237: {de: ["beeindruckend"], fr: ["impressionant", "impressionante"]},
            238: {de: ["ein Gift"], fr: ["un poison"]},
            239: {de: ["ein Fehler"], fr: ["une faute"]},
            240: {de: ["nett"], fr: ["gentil", "gentille"]},
            241: {de: ["ein Wettkampf"], fr: ["une compétition"]},
            242: {de: ["ein Strandsegler"], fr: ["un char à voile"]},
            243: {de: ["ein Heft", "ein Notitzbuch", "ein Heftchen"], fr: ["un carnet"]},
            244: {de: ["ein Reisetagebuch"], fr: ["un carnet de voyage"]},
            245: {de: ["ein Kräutertee"], fr: ["une infusion"]},
            246: {de: ["ein Tee"], fr: ["un thé"]},
            247: {de: ["Kräuter"], fr: ["des herbes"]},
            248: {de: ["ein Krankenhaus"], fr: ["un hôpital"]},
            249: {de: ["krank"], fr: ["malade"]},
            250: {de: ["eine Infusion"], fr: ["une perfusion"]},
            251: {de: ["falsch"], fr: ["faux", "fausse"]},
            252: {de: ["ein Nieveau", "eine Stufe"], fr: ["un niveau"]},
            253: {de: ["ein Abend"], fr: ["une soirée"]},
            254: {de: ["touristisch"], fr: ["touristique"]},
            255: {de: ["eine Bucht"], fr: ["une baie"]},
            256: {de: ["ein Schild", "ein Hinweisschild"], fr: ["un panneau"]},
            257: {de: ["eine Gefahr"], fr: ["un danger"]},
            258: {de: ["genau"], fr: ["exactement"]},
            259: {de: ["die Gezeiten"], fr: ["les marées"]},
            260: {de: ["obligatorisch"], fr: ["obligatoire"]},
            261: {de: ["ablegen"], fr: ["passer"]},
            262: {de: ["spazieren gehen"], fr: ["se promener"]},
            263: {de: ["ein Meter"], fr: ["un mètre"]},
            264: {de: ["durch", "mit"], fr: ["par"]},
            265: {de: ["ein Herzog"], fr: ["un duc"]},
            266: {de: ["ein Pferd", "Pferde"], fr: ["un cheval", "des chevaux"]},
            267: {de: ["kämpfen"], fr: ["se battre"]},
            268: {de: ["ein Sieg"], fr: ["une victoire"]},
            269: {de: ["ein König", "eine Königin"], fr: ["un roi", "une reine"]},
            270: {de: ["eine Szene"], fr: ["une scène"]},
            271: {de: ["das Mittelalter"], fr: ["le Moyen Age"]},
            272: {de: ["der Bau", "die Konstruktion"], fr: ["la construction"]},
            273: {de: ["Welt-"], fr: ["mondial", "mondiale", "mondiaux", "mondiales"]},
            274: {de: ["ein Soldat"], fr: ["un soldat"]},
            275: {de: ["amerikanisch"], fr: ["américain", "américaine"]},
            276: {de: ["englisch"], fr: ["anglais", "anglaise"]},
            277: {de: ["kanadisch"], fr: ["canadien", "canadienne"]},
            278: {de: ["befreien"], fr: ["libérer"]},
            279: {de: ["die Naibesatzung"], fr: ["l'occupation nazie"]},
            280: {de: ["ein Betonblock"], fr: ["un bloc de béton"]},
            281: {de: ["die Alliierten"], fr: ["les Alliés"]},
            282: {de: ["lenken", "steuern"], fr: ["diriger"]},
            283: {de: ["trainieren"], fr: ["s'entraîner"]},
            284: {de: ["ein Rad"], fr: ["une roue"]},
            285: {de: ["sich verletzen"], fr: ["se blesser"]},
            286: {de: ["bewegen"], fr: ["bouger"]},
            287: {de: ["die Notaufnahme"], fr: ["les urgences"]},
            288: {de: ["ein Arzt", "eine Ärztin"], fr: ["un médecin", "une médecin"]},
            289: {de: ["eine Verstauchung"], fr: ["une foulure"]},
            290: {de: ["ein Patient", "eine Patientin"], fr: ["une patient", "une patiente"]},
            291: {de: ["einen Termin vereinbaren", "sich verabreden"], fr: ["prendre rendez-vous"]},
            292: {de: ["ein Doktor", "eine Doktorin", "ein Arzt", "eine Ärztin"], fr: ["un docteur", "une docteure"]},
            293: {de: ["dringend"], fr: ["urgent", "urgente"]},
            294: {de: ["der Hals"], fr: ["la gorge"]},
            295: {de: ["das Fieber"], fr: ["la fièvre"]},
            296: {de: ["sie brauchen", "ihr braucht"], fr: ["il vous faut"]},
            297: {de: ["ein Rezept"], fr: ["une ordonnance"]},
            298: {de: ["eine Krankheit"], fr: ["une maladie"]},
            299: {de: ["eine Krankenversicherung"], fr: ["une assurance maladie"]},
            300: {de: ["eine Apotheke"], fr: ["une pharamacie"]},
            301: {de: ["zurückzahlen", "erstatten"], fr: ["rembourser"]},
            302: {de: ["widersehen"], fr: ["revoir"]},
    ...
    5: {
        name: "Unité 5",
        words: {
            303: {de: ["die Frankofonie"], fr: ["la francophonie"]},
            304: {de: ["die Gemeinsamheit"], fr: ["l'ensemble"]},
            305: {de: ["täglich"], fr: ["quotidien", "quotidienne"]},
            306: {de: ["französischsprachig"], fr: ["francophone"]},
            307: {de: ["ein Fernsehsender"], fr: ["une chaîne de télévision"]},
            308: {de: ["eine Fahne", "eine Flagge"], fr: ["un drapeau"]},
            309: {de: ["eine Landschaft"], fr: ["un paysage"]},
            310: {de: ["riesig", "Riesen-"], fr: ["énorme"]},
            311: {de: ["Kanada"], fr: ["le Canada"]},
            312: {de: ["absolut"], fr: ["absolu", "absolue"]},
            313: {de: ["gehören", "Teil sein"], fr: ["faire partie"]},
            314: {de: ["Amerika"], fr: ["l'Amérique"]},
            315: {de: ["ein Gebiet", "ein Territorium"], fr: ["un territoire"]},
            316: {de: ["ein Kontinent"], fr: ["un continent"]},
            317: {de: ["vorhanden", "anwesend"], fr: ["présent", "présente"]},
            318: {de: ["Belgien"], fr: ["la Belgique"]},
            319: {de: ["die Schweiz"], fr: ["la Suisse"]},
            320: {de: ["eine Provinz"], fr: ["une province"]},
            321: {de: ["eine Muttersprache"], fr: ["une langue maternelle"]},
            322: {de: ["Algerien"], fr: ["l'Algerie"]},
            323: {de: ["Tunesien"], fr: ["la Tunisie"]},
            324: {de: ["das Arabische"], fr: ["l'arabe"]},
            325: {de: ["Verwaltungs-", "behördlich"], fr: ["administratif", "administrative"]},
            326: {de: ["die Medien"], fr: ["les médias"]},
            327: {de: ["die Antillen"], fr: ["les Antilles"]},
            328: {de: ["fließend"], fr: ["courant", "courante"]},
            329: {de: ["also"], fr: ["donc"]},
            330: {de: ["eine Rolle"], fr: ["un rôle"]},
            331: {de: ["im Laufe"], fr: ["au cours de"]},
            332: {de: ["Portugal"], fr: ["le Portugal"]},
            333: {de: ["eine Kolonie"], fr: ["une colonie"]},
            334: {de: ["ein Franzose", "eine Französin"], fr: ["un Français", "une Française"]},
            335: {de: ["der Reichtum"], fr: ["la richesse"]},
            336: {de: ["unabhängig"], fr: ["indépendant", "indépendante"]},
            337: {de: ["ein Drittel"], fr: ["un tiers"]},
            338: {de: ["vollständig", "völlig", "total"], fr: ["total", "totale", "totaux", "totales"]},
            339: {de: ["Partner-"], fr: ["partenaire"]},
            340: {de: ["eine Partnerschaft haben mit"], fr: ["être jumelé avec", "être jumelée avec"]},
            341: {de: ["eine Amtssprache"], fr: ["une langue officielle"]},
            342: {de: ["ein Quebecer", "eine Quebecerin"], fr: ["un Québécois", "une Québécoise"]},
            343: {de: ["bayerisch"], fr: ["bavarois", "bavaroise"]},
            344: {de: ["geiss", "sicher"], fr: ["certain", "certaine"]},
            345: {de: ["das Eis"], fr: ["la glace"]},
            346: {de: ["das Eishockey"], fr: ["le hockey sur glace"]},
            347: {de: ["wunderschön", "großartig"], fr: ["magnifique"]},
            348: {de: ["ein See"], fr: ["le lac"]},
            349: {de: ["national", "staatlich"], fr: ["nationial", "nationale", "nationaux", "nationales"]},
            350: {de: ["eine Wanderung"], fr: ["une randonnée"]},
            351: {de: ["wandern"], fr: ["faire de la randonnée"]},
            352: {de: ["ein Kanu"], fr: ["un canoë"]},
            353: {de: ["ein Schlitten"], fr: ["un traîneau"]},
            354: {de: ["ein Quadratkilometer"], fr: ["un kilomètre carré"]},
            355: {de: ["ein Snowboard"], fr: ["un snowboard"]},
            356: {de: ["ein Wal"], fr: ["une baleine"]},
            357: {de: ["angeln"], fr: ["pêcher"]},
            358: {de: ["die Vereinigten Staaten"], fr: ["les Etats-Unis"]},
            359: {de: ["der Atlantik"], fr: ["l'Atlantique"]},
            360: {de: ["sterben"], fr: ["mourir"]},
            361: {de: ["unterirdisch"], fr: ["souterrain", "souterraine"]},
            362: {de: ["einen Einkaufsbummel machen", "shoppen"], fr: ["faire du shopping"]},
            363: {de: ["dynamisch", "lebhaft"], fr: ["dynamique"]},
            364: {de: ["typisch"], fr: ["typique"]},
            365: {de: ["eine Soße"], fr: ["une sauce"]},
            366: {de: ["der Ahornsirup"], fr: ["le sirop d'érable"]},
            367: {de: ["herstellen"], fr: ["fabriquer"]},
            368: {de: ["zählen"], fr: ["compter"]},
            369: {de: ["ein Karibu"], fr: ["un caribou"]},
            370: {de: ["ein Ureinwohner", "eine Ureinwohnerin"], fr: ["un autochtone", "une autochtone"]},
            371: {de: ["gründen"], fr: ["fonder"]},
            372: {de: ["ein Inuit", "eine Inuit"], fr: ["un Inuit", "une Inuit"]},
            373: {de: ["die Arktis"], fr: ["l'Arctique"]},
            374: {de: ["ein Eisbär"], fr: ["un ours polaire"]},
            375: {de: ["eine Begegnung", "ein Treffen"], fr: ["une rencontre"]},
            376: {de: ["die Olympischen Spiele"], fr: ["les Jeux olympiques"]},
            377: {de: ["der hohe Norden"], fr: ["le Grand Nord"]},
            378: {de: ["am meisten"], fr: ["le plus"]},
            379: {de: ["der Schnee"], fr: ["la neige"]},
            380: {de: ["ein Sturm", "ein Unwetter"], fr: ["une tempête"]},
            381: {de: ["darstellen", "vertreten", "verkörpern"], fr: ["représenter"]},
            382: {de: ["sich entfernen"], fr: ["s'éloigner"]},
            383: {de: ["der Langlauf"], fr: ["le ski de fond"]},
            384: {de: ["verbessern"], fr: ["améliorer"]},
            385: {de: ["eine Technik"], fr: ["une technique"]},
            386: {de: ["sich nähern"], fr: ["s'approcher"]},
            387: {de: ["reagieren"], fr: ["réagir"]},
            388: {de: ["beruhigen"], fr: ["calmer"]},
            389: {de: ["vorsichtig"], fr: ["prudent", "prudente"]},
            390: {de: ["benachrichtigen", "warnen"], fr: ["avertir"]},
            391: {de: ["ein Jäger", "eine Jägerin"], fr: ["un chasseur", "une chasseuse"]},
            392: {de: ["sich auf die Suche machen", "auf die Suche gehen"], fr: ["partir à la recherche"]},
            393: {de: ["die Nahrung"], fr: ["la nourriture"]},
            394: {de: ["jedenfalls", "auf jeden Fall"], fr: ["en tout cas"]},
            395: {de: ["ein verhalten"], fr: ["un comportement"]},
